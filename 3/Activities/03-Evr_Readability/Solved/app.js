...
d3.csv("donuts.csv").then(function(donutData) {
  ...
  chartGroup.append("text")
    ...
    //the above translate creates a centered item for the label
  ...
  chartGroup.append("text")
    ...
    //the margin is offset so no on top of the other so the lables are stacked
    //plotly would be easier
    .attr("text-anchor", "middle")
    .attr("font-size", "16px")
    .attr("fill", "orange")
