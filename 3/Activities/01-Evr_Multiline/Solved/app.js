...
//working within datasources - this extends all the way to the end - do not close until the end with the catch function
// =================================
d3.csv("donuts.csv").then(function(donutData) {
  ...
  //why the if statement?  set the domain for the greater height value then below setting the domain based on the higher value
  //the arrangement of code here makes it confusing (yLinearScale is set above)
  ...
  // =================================
  //****see d3 documentation for formatting such as tickFormat*****
  ...
  var line2 = d3.line()
    ...
    //2 options for path (line 1 and 2do the same thing 
  // Append a path for line1
  chartGroup
    .append("path")
    //this is the svg path reference
    .attr("d", line1(donutData))
    .classed("line green", true);

  // Append a path for line2
  chartGroup
  //.data is binding first
    .data([donutData])
    .append("path")
    .attr("d", line2)
...
//no labels yet 
//can also have 2 Y axis for the different scale instead of mapping the highest - see activity 2
